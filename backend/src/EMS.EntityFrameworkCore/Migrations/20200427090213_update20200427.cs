...
{
    public partial class update20200427 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmsTrainNotices", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AttachmentTypeElementCode = table.Column<string>(maxLength: 256, nullable: false),
                    BussinessTypeElementCode = table.Column<string>(maxLength: 256, nullable: false),
                    BussinessId = table.Column<int>(nullable: false),
                    IsDeleted = table.Column<bool>(nullable: false),
                    EmsTrainNoticeId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmsAttachments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EmsAttachments_EmsTrainNotices_EmsTrainNoticeId",
                        column: x => x.EmsTrainNoticeId,
