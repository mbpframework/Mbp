  ...
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="月份" align="center">
        <template slot-scope="{row}">
          <span class="link-type" @click="handleUpdate(row)">{{ row.Month| moment("YYYY-MM") }}</span>
        </template>
      </el-table-column>
...
<script>
import { AddTrainPlanMonth, UpdateTrainPlanMonth, GetTrainPlanMonths, DeleteTrainPlanMonth } from '@/api/bll/plan/monthplan'
...
export default {
  ...
  data() {
    ...
    return {
      ...
      uploadData: { AttachmentTypeElementCode: 'document', BussinessTypeElementCode: 'TrainPlanMonth', BussinessId: guid() },
      attachList: [],
  ...
  methods: {
    handleBeforeUpload(file) {
      ...
      this.uploadData.BussinessTypeElementCode = 'TrainPlanMonth'
    ...
    getList() {
      this.listLoading = true
      GetTrainPlanMonths(this.listQuery).then(response => {
    ...
    createData() {
      ...
      this.$refs['dataForm'].validate(valid => {
        if (valid) {
          AddTrainPlanMonth(this.temp).then(() => {
    ...
    updateData() {
      ...
      this.$refs['dataForm'].validate(valid => {
        if (valid) {
          ...
          UpdateTrainPlanMonth(tempData).then(() => {
    ...
    handleDelete(row) {
      DeleteTrainPlanMonth(row.Id).then(() => {
        this.$notify({
          title: 'Success',
